...
CREATE TABLE detalles_taquilla (
  taquilla_id bigint NOT NULL AUTO_INCREMENT,
  presupuesto decimal(15, 2),
  recaudacion decimal(15, 2),
  pelicula_id bigint NOT NULL,
  PRIMARY KEY (taquilla_id),
  UNIQUE KEY UK_pelicula_id (pelicula_id), -- ¡La clave del 1:1!
  CONSTRAINT FK_taquilla_pelicula FOREIGN KEY (pelicula_id) REFERENCES peliculas (pelicula_id) ON DELETE CASCADE
);

-- Datos de ejemplo
INSERT INTO detalles_taquilla (presupuesto, recaudacion, pelicula_id) VALUES
